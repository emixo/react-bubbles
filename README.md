...
A token is used for authentification for a login if a token matches the login.

- [x] What steps can you take in your web apps to keep your data secure?
To keep your data secure you would most likely want to set up private routing which reroutes to the login page and wont show any data until the user logs in

- [x] Describe how web servers work.
A webserver is stored code in combination with software and hardware that sends data to the internet through a domain name.
